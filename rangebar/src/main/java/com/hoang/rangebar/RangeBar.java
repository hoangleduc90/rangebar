...
public class RangeBar extends View {
    ...
    //HoangLe custom 15/10/2015
    private boolean isShowNumberInCenterIcon = false;
    private float mNumberTextSize = 14;
    private boolean isShowRightThumb = true;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mLeftThumb.draw(canvas, getLeftIndex());
        if (isShowRightThumb) mRightThumb.draw(canvas, getRightIndex());
    ...
    private void rangeBarInit(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            //
            mNumberTextSize = ta.getDimension(R.styleable.RangeBar_textSizeInIcon, 14);
            isShowNumberInCenterIcon = ta.getBoolean(R.styleable.RangeBar_isShowNumberInCenterIcon, false);
            isShowRightThumb = ta.getBoolean(R.styleable.RangeBar_isShowRightThumb, true);
        } finally {
    ...
    public boolean isShowNumberInCenterIcon() {
        return isShowNumberInCenterIcon;
    }

    public void setIsShowNumberInCenterIcon(boolean isShowNumberInCenterIcon) {
        this.isShowNumberInCenterIcon = isShowNumberInCenterIcon;
    }
    ...
    public void setIsShowRightThumb(boolean isShowRightThumb) {
